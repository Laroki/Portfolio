...
frontPage.addEventListener('click', function () {
  ...
  if (!!document.querySelector('.cube--isOpen')) {
    ...
    wrap.classList.remove('wrap--isOpen'); // délai avant dezoom
...
burger.addEventListener('click', function () {
  ...
  if (!!document.querySelector('.cube--isOpen')) {
    ...
    wrap.classList.toggle('wrap--isOpen'); // attendre X secondes avant de dezoom
    ...
    setTimeout(function () {
      ...
      // dezoom
      cube.classList.toggle('cube--isOpen'); //délai de 0.X s pour translate le cube + le menu caché
